      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary border border-border mb-8 animate-fade-in">
            ...
            <span className="text-sm text-muted-foreground">Secure & Transparent Crypto Investment</span>
          </div>
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-bold mb-6 animate-fade-in" style={{ animationDelay: '0.1s' }}>
            ...
            <br />
            <span className="text-gradient-gold">Transparent Growth.</span>
            <br />
            Secure Future.
          </h1>
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            manually-verified crypto investments with complete transparency.
          </p>
